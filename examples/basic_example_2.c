...
int main(void){
    ...
    char* target_body = "301"; // Reminder: strings are case sensitive
    char* ephem_type = "Vector Table"; /* Options:
                                            ...
                                            - "Approach"
                                        */
    char* center = "708"; /* Some common options: 
    ...
    char* stop  = "2025-05-06 00:00:00"; // Date must appear exactly as it does in Horizons
    ...
    char* units = "KM-S"; /* <length unit>-<time unit>. Options:
                                ...
                                - "KM-D"
                          */
    char* vec_table_set = "2"; /* Only an option if ephem_type = "Vector Table"
                                ...
                                */
    char* file_name = "./outputs/rv_Moon_Ground_ec_basic.txt"; 
